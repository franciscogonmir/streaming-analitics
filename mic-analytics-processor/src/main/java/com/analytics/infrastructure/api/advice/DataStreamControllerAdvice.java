...
public class DataStreamControllerAdvice {
    ...
    Map<String,String> statsNotFoundHandler(final StatsNotFoundException exception) {
    ...
    Map<String,String> invalidParameterHandler(final InvalidParameterException exception) {
        return Map.of("Message: ",exception.getMessage());
    }
    @ResponseBody
    @ResponseStatus(HttpStatus.BAD_REQUEST)
